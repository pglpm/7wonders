...
%% Last-Updated: 2025-02-09T18:40:08+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anontrue
\newif\ifarxiv
...
\begin{enumerate}[exerc]
\item Suppose that through a control surface, in a given crossing direction, there is a non-zero flux of momentum. Momentum is a quantity related to movement. Does this mean that the control surface must be in motion?
...
\begin{enumerate}[exerc]
\item No, the control surface may also be completely still (in that coordinate system). For several reasons:
  \begin{itemize}[nosep]
  \item \emph{Volume content} of momentum means that something (matter or electromagnetic field) inside the volume must be moving.
  \item A control surface may be completely imaginary, so it doesn't need to be something that is affected by any physical influence.
  \end{itemize}

\item No: \emph{in principle} the fluxes of the seven quantities are independent and can all be non-zero. In fact, in many physical situations they are connected by particular physical laws.
...
%% ask/discuss difference between balance and conservation, and why conservation is more powerful

\section{}
\label{sec:change_bal_or_const}
%% new discovery; should one change balance or constitutive
