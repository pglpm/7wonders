...
%% Last-Updated: 2025-02-11T10:27:25+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anontrue
\newif\ifarxiv
...
\item A bowling ball, at a given time and in a given coordinate system, has momentum $[11.6,0,0.6]\,\unit{N\,s}$. Three seconds later the ball is completely at rest, with momentum $[0,0,0]\,\unit{N\,s}$. How much was the time-integrated influx of momentum during the three seconds?

\item A small laser beam, of given width and length, contains a net angular momentum $[0, 2.1e-36,0]\,\unit{N\,m\,s}$, in a given coordinate system. The same region of space, \qty{0.1}{s} later, does not contain any electromagnetic field anymore, and therefore contains zero angular momentum. Assume that angular momentum satisfies a conservation law. How much was the time-integrated efflux of angular momentum through the control surface that contained the beam?
\end{enumerate}

\section{}
\label{sec:calc_from_bal}

Find the requested quantity, if possible, by using any combination of:
\begin{itemize}[nosep]
\item given data,
...
\item We consider an imaginary closed control surface perfectly wrapping the bowling ball (note that this control volume and surface are not static).
  ...
  \item Volume content of momentum $\yP(\yti)=[11.6,0,0.6]\,\unit{N\,s}$ at time $\yti$.
...
\item  We consider an imaginary and static closed control surface enclosing the region where the laser beam (the electromagnetic field) was initially.
  ...
  \item Angular-momentum content $\yL(\yti)=[0, 2.1e-36,0]\,\unit{N\,m\,s}$ at time $\yti$.
...
\begin{equation*}
  \begin{split}
   ...
   \\&= [0, 2.1e-36,0]\,\unit{N\,m\,s} - [0,0,0]\,\unit{N\,m\,s}
    = [0, 2.1e-36,0]\,\unit{N\,m\,s} \ .
  \end{split}
\end{equation*}
