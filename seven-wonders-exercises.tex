...
%% Last-Updated: 2025-01-30T08:04:45+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anontrue
\newif\ifarxiv
...
\addsubsecref{sec:1Dintegration}
...
\addsubsecref{sec:extensive_vs_meas}
...
\addsubsecref{sec:energy_meas_mass}
...
\item Energy:\qquad \includegraphics[align=c,height=10em]{images/ex_AB_J1.jpg}%
...
\begin{enumerate}[exerc,itemsep=2ex]
\item \qquad \includegraphics[align=c,height=10em]{images/ex_AB_P0.jpg}%
\item \qquad \includegraphics[align=c,height=10em]{images/ex_AB_Pov.jpg}%
\item \qquad \includegraphics[align=c,height=10em]{images/ex_AB_P1.jpg}%
\item \qquad \includegraphics[align=c,height=10em]{images/ex_AB_Pin.jpg}%
\item \qquad \includegraphics[align=c,height=10em]{images/ex_AB_Pdi.jpg}%
\end{enumerate}
...
\marginpar{\vspace{\baselineskip}\centering\includegraphics[width=\linewidth]{images/ex_AB_light_ball.jpg}%
}%
...
\addsubsecref{sec:contents}

\begin{enumerate}[exerc]
\item Net content is $\yE_{\text{A}} + \yE_{\text{B}} = \qty{22.1}{J}$.
...
\item Net content is $\yC_{\text{A}} + \yC_{\text{B}} = \qty{2}{C}$.
\end{enumerate}


\addsubsecref{sec:Pcontents}
\begin{enumerate}[exerc]
