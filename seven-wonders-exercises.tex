...
%% Last-Updated: 2025-02-27T00:43:26+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anontrue
\newif\ifarxiv
...
\begin{equation*}
  ...
  \end{dcases}
\end{equation*}
where $k$ is a constant, and $d$ is the diameter of one tennis ball, or equivalently the distance between their centres when they touch.
...
\item How does the \emph{magnitude} of the momentum influx $\yFa$ depend on distance? Does it increase or decrease when the distance decreases? What is its value when $\yra = \yrb$, that is, the centres of the tennis balls coincide?
...
and adding
  ...
  \begin{center}
    \hfill\includegraphics[width=\linewidth]{images/tennisball_highg_highv.pdf}%
  \end{center}
