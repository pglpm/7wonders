...
%% Last-Updated: 2026-02-18T13:25:30+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\marginpar{\vspace{2\baselineskip}\centering\footnotesize\includegraphics[width=\linewidth]{images/wind_building_solution.jpg}%
%\\\flushleftright\color{mpcolor}%
}
%
