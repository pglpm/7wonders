...
%% Last-Updated: 2026-03-17T10:20:41+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\begin{equation*}
  \begin{aligned}
    ...
    \\
    &\qty{1}{kg} \cdot \frac{\di v_{z}}{\dt} = F_{x} - \qty{9.8}{N}
    \\
    &F_{x} = F_{z}
  \end{aligned}
\end{equation*}
...
%
It could also be that the $x$- and $z$-components of the force are extremely large, say \qty{100}{N} or \qty{1000}{N}. In this case the $x$- and $z$-accelerations would also be positive and large , approximately \qty{+100}{m/s^2} and \qty{+990}{m/s^2}. This could be the case if the object is in the middle of bouncing on the surface, when the surface exerts extremely high reaction forces (indeed objects compress to a small or high degree when bouncing).
