...
%% Last-Updated: 2026-02-26T22:15:55+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\section{}
\label{sec:tennisballs_collision}
...
\sollabel{sec:tennisballs_collision}
...
\subsection{An inconclusive approach}
...
\subsection{Approach via differential equations}
...
\section{}
\label{sec:tennisball_fall_energy}


\clearpage
\addsec{Example solutions}

\sollabel{sec:skydiver}
