...
%% Last-Updated: 2026-03-13T11:08:50+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
Let's denote the contact surface on the left with $a$ and the one on the right with $b$. Their unit normal vectors, denoted $\ye_{a}$ and $\ye_{b}$, are obviously
\begin{equation*}
  \ye_{a} = [1, 0] \ , \qquad \ye_{b} = -[1, 0] \ .
\end{equation*}
