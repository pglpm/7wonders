...
%% Last-Updated: 2026-03-17T13:52:22+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\end{equation*}
and found that these forces are equal to
\begin{equation*}
  \yFa = [0, 0, 3]\,\unit{N}
  \quad\text{and}\quad
  \yFb = [0, 0, -3]\,\unit{N}  \ .
...
Is the engineer's decision reasonable? \emph{(Hint: review the discussion about the consequences of assuming zero mass for a piece of material in \chaps~10 and~12 of our lecture notes.)}
