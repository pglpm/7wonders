...
%% Last-Updated: 2025-03-08T10:14:45+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anontrue
\newif\ifarxiv
...
\begin{itemize}
\item $b$: physical dimension $\textsf{energy}$, unit \enquote*{\unit{J}}.
\item $d$: physical dimension $\textsf{temperature}$, unit \enquote*{\unit{K}}.
...
\item $\yU_{0}$: physical dimension $\textsf{energy}$, unit \enquote*{\unit{J}}.
\item $C$: physical dimension $\textsf{energy}/(\textsf{substance}\cdot\textsf{temperature})$, unit \enquote*{\unit{J/(mol\,K)}}.
\end{itemize}
