...
%% Last-Updated: 2026-03-05T09:43:15+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
Assume there's no friction between ice and the skaters, and that the gravitational potential energy of each skater is constant. The skater on the left has \masse\ \qty{70}{kg}, the one on the right \qty{60}{kg}. Each skater can be considered as a point, and the problem can be taken as one-dimensional.
...
\item The internal energy at the final time $\ytf$ is lower than that at the initial time $\yti$.
\item The kinetic energy at the initial time $\yti$ is zero, whereas that at the final time $\ytf$ is non-zero (and obviously positive).
\end{enumerate}
...
% Let's decide first how many control volumes to consider. Between the initial and final times there is obviously a flux and exchange of momentum, and possibly also of heat and of mechanical work, between the skaters. If we consider the skaters as two separate control volumes, then when we write the balance of momentum or that of energy we would have to explicitly write such fluxes of momentum and of energy. The text, however, does not give any information about these fluxes. Therefore let's try to solve the problem considering the skaters as a single control volume: this way the fluxes of momentum and energy between them are internal and don't appear in the balances of momentum and energy.
