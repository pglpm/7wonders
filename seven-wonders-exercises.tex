...
%% Last-Updated: 2026-03-20T08:16:41+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
Half a second later, both disks have mass-centres at $z$-coordinate \qty{1.0}{m} and zero velocities, and neither disk is spinning (that is, both angular velocities are \qty{0}{rad/s}). The internal energy of disk~$a$ has increased by \qty{2}{J}, and that of disk~$b$ by \qty{1}{J}.
...
Let's reason about what kind of choices of control volumes and balance laws seem most convenient.
...
\emph{Short motivation:} We consider both disks together as one control volume, so that the interactions between the disks become internal and can be avoided.
