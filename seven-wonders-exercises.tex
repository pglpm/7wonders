...
%% Last-Updated: 2026-03-17T10:57:29+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
Is the engineer's decision reasonable?
...
%
The following prompt was given to ChatGPT (version~5.1):
...
Let's analyse the problem, and then compare our analysis with ChatGPT's output.
...
Let's now analyse some statements in ChatGPT's output. Again, we must not think of these statements as coming from some kind of reasoning: \emph{they don't}. They're only produced by long-range correlations among words matched from some corpus of text.
