...
%% Last-Updated: 2026-03-20T11:40:50+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\item Initial angular velocity disk~$a$: $\yo_{a}(\yti) = \qty{0.0}{rad/s}$.
...
\item Final angular velocity disk~$a$: $\yo_{a}(\ytf) = \qty{0}{rad/s}$.
\item Final angular velocity disk~$b$: $\yo_{a}(\ytf) = \qty{0}{rad/s}$.
...
Required: $v_{a,x}(\yti)$, $v_{a,z}(\yti)$, $\yo_{b}(\yti)$.
...
\item Constitutive relation for the total energy of a rigid body: $\yE = \yU + \tfrac12\ym\yvcm^{2} + \ym g \yzcm + \tfrac12 \yIc \yo^{2}$. It has to be used for each disk at the initial and final time instants.
...
\begin{equation*}
    ...
    \begin{aligned}
      ...
      \tfrac12 \underbracket[0.5pt]{\yIc \yo_{a}(\yti)^{2}}_{\qty{0}{J}} {}
      +{}\\
      &\quad\yU_{b}(\yti) +
    ...
    \begin{aligned}
      ...
      \ym g z_{a}(\ytf) +
      \tfrac12 \underbracket[0.5pt]{\yIc \yo_{a}(\ytf)^{2}}_{\qty{0}{J}}{}
      +{}\\
      &\quad\yU_{b}(\ytf) +
      \tfrac12\underbracket[0.5pt]{\ym \bigl[v_{b,x}(\ytf)^{2} + v_{b,z}(\ytf)^{2}\bigr]}_{\qty{0}{J}} +
      \ym g z_{b}(\ytf) +
      \tfrac12 \underbracket[0.5pt]{\yIc \yo_{b}(\ytf)^{2}}_{\qty{0}{J}}{}
    \end{aligned}
    &&\qquad\text{\footnotesize energy content, extensivity}
  \end{aligned}
\end{equation*}
