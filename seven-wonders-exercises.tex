...
%% Last-Updated: 2026-02-17T23:46:37+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
Consider the constitutive relation for a surface force $\yF$ in the case where matter is flowing through a static surface with perpendicular velocity $v$:
\begin{equation*}
  \yF = A \yrho v \yv + \yFt
\end{equation*}
where:
...
\item[] $\yFt$, called the pressure vector or stress vector, is the force that there would be on the surface if matter weren't flowing through it.
\end{itemize}

In the present case, this constitutive relation can be applied to the vertical surface represented by the vertical, \textcolor{yellow}{yellow dashed line} in the margin figure. The surface force there is called $\yF_{\textrm{left}}$. The pressure vector $\yFt$ is the horizontal force from atmospheric pressure:
\begin{equation*}
  \mathcal{F} = A\,p
  \qquad\text{with}\quad
