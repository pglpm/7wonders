...
%% Last-Updated: 2026-03-07T09:55:58+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
Assume there's no friction or heat flux between ice and the skaters, air is negligible, and that the gravitational potential energy of each skater is constant. The skater on the left has \masse\ \qty{70}{kg}, the one on the right \qty{60}{kg}. Each skater can be considered as a point, with zero vertical momentum.
...
The full set of equations describing this physical situation is therefore the following, denoting one skater $a$ and the other $b$, and with $g=\qty{9.8}{m/s}$:
\begin{equation*}
  \begin{aligned}
    & P_{x}(\ytf) = P_{x}(\yti)
