...
%% Last-Updated: 2026-02-16T23:25:44+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
%
Two blocks of granite rest on the ground leaning against each other as shown in the margin figure. Each block touches the ground and the other block. There are momentum fluxes (contact forces) at the three contact surfaces, as depicted in the figure. The block on the left, denoted \enquote*{L}, has mass \qty{27000}{kg}; the one on the right, denoted \enquote*{R}, mass \qty{9000}{kg}. Air can be neglected.
...
\item It looks like we have enough information if we focus on the \emph{right block} only, considered as one control volume. The physical principles we need are:
  ...
  \begin{equation*}
    \begin{aligned}
      &\frac{\di\yP_{\textrm{R}}}{\dt} = \yF_{\textrm{R}} + \yG_{\textrm{R}}
        ...
        \\
        &\yG_{\textrm{R}} = -\ym_{\textrm{R}} g\, \begin{bsmallmatrix}0\\1\end{bsmallmatrix}
        \approx \begin{bsmallmatrix}0\\ -\num{88000}\end{bsmallmatrix}\,\unit{N}
        &\qquad&\mathrlap{\text{\footnotesize\color{midgrey}constit. rel. for gravity force}}
        \\
        &\frac{\di\yP_{\textrm{R}}}{\dt} =  \begin{bsmallmatrix}0\\0\end{bsmallmatrix}\,\unit{N}
          &\qquad&\mathrlap{\text{\footnotesize\color{midgrey}static situation}}
          \\
        &\yF_{\textrm{L\,top}} = \begin{bsmallmatrix}F_{\textrm{L\,top,x}}\\\qty{0}{N}\end{bsmallmatrix}
        &\qquad&\mathrlap{\text{\footnotesize\color{midgrey}info}}
          \\
        &\yF_{\textrm{R\,bot}} = \begin{bsmallmatrix}-\qty{33075}{N}\\ F_{\textrm{R\,bot,z}}\end{bsmallmatrix}
        &\qquad&\mathrlap{\text{\footnotesize\color{midgrey}info}}
    \end{aligned}
  \end{equation*}
  ...
  \begin{equation*}
    \begin{aligned}
      ...
      \\
      \implies\quad
      \begin{bsmallmatrix}0\\0\end{bsmallmatrix}\,\unit{N} &= \yF_{\textrm{R}} + \yG_{\textrm{R}}
      &\qquad&\mathrlap{\text{\footnotesize\color{midgrey}static situation}}
      \\
      \implies\quad
      \begin{bsmallmatrix}0\\0\end{bsmallmatrix}\,\unit{N} &= \yF_{\textrm{R\,top}} + \yF_{\textrm{R\,bot}}
      + \yG_{\textrm{R}}
      &\qquad&\mathrlap{\text{\footnotesize\color{midgrey}extensivity}}
      \\
      \implies\quad
      \begin{bsmallmatrix}0\\0\end{bsmallmatrix}\,\unit{N} &= -\yF_{\textrm{L\,top}} + \yF_{\textrm{R\,bot}}
      + \yG_{\textrm{R}}
      &\qquad&\mathrlap{\text{\footnotesize\color{midgrey}symmetry of flux}}
      \\
      \implies\quad
      \begin{bsmallmatrix}0\\0\end{bsmallmatrix}\,\unit{N} &=
      -\begin{bsmallmatrix}
        F_{\textrm{L\,top,x}}
        \\ \qty{0}{N}
      \end{bsmallmatrix}
