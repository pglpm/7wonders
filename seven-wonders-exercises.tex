...
%% Last-Updated: 2026-01-22T19:46:08+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\newcommand*{\yRu}{\yR_{\text{u}}}
\newcommand*{\yRv}{\yR_{\text{v}}}
...
\begin{itemize}
\item $\yRv(t) = \lambda_{\text{u}} \yNu(t)\,, \quad\yRu(t) = -\lambda_{\text{v}} \yNv(t)$\\ with different positive values for $\lambda_{\text{u}}$ and $\lambda_{\text{v}}$.

\item $\yRv(t) = \lambda \yNu(t)\, \yNv(t)\,, \quad\yRu(t) = -\lambda \yNu(t)\, \yNv(t)$\,.

\item $\yRv(t) = \lambda \sin[\yNu(t)\, \yNv(t)/\unit{mol^{2}}]\,, \quad\yRu(t) = -\lambda \sin[\yNu(t)\, \yNv(t)/\unit{mol^{2}}]$\,.
...
\item Categorization~\ref{item:materials} surely apply here: we must keep track of amounts of various kinds of metals, wood, cement, and many other materials. Possibly also categorizations~\ref{item:solid_liquid_gas} and \ref{item:elements_compounds} may be relevant in some situations.
