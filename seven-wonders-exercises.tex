...
%% Last-Updated: 2026-03-12T07:59:14+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
%
\newcommand{\exercise}[2]{\section{#2}\label{#1}\marginpar{\vspace{-1.5\baselineskip}\hspace{-8em}\footnotesize Solution p.~\pageref{#1_sol}}}
...
\exercise{sec:time_vel_primitive}{}
...
\exercise{sec:scalar_vect_quants}{}
...
\exercise{sec:extensive_vs_meas}{}
...
\exercise{sec:surface_moves_if_flux}{}
...
\exercise{sec:constants_previous}{}
...
\exercise{sec:calc_from_bal2-watertank}{}
...
\exercise{sec:calc_from_bal2-capacitors}{}
...
\exercise{sec:calc_from_bal2-capacitors-carbreak}{}
...
\exercise{sec:calc_from_bal2-capacitors-nuclearplant}{}
...
\exercise{sec:NO2_reaction_later}{}
...
\exercise{sec:calc_from_bal2-scripts}{}
...
\exercise{sec:kinds_matter_select}{}
...
\exercise{sec:football_integral}{}
...
\exercise{sec:tennisballs_collision}{}
...
\exercise{sec:tennisball_double}{}
...
\exercise{sec:tennisball_collision_theory}{}
...
\exercise{sec:tennisball_collision_script}{}
...
\exercise{sec:state_scripts_hooke}{}
...
\needspace{12\baselineskip}
\exercise{sec:bullet_block_energy}{}
...
\exercise{sec:tennisball_fall_energy}{}
...
\exercise{sec:imagine_momentum_energy}{}
...
\exercise{sec:idealgas_kineticenergy}{}
