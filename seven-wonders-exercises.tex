...
%% Last-Updated: 2026-02-19T07:57:23+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
In a coordinate system $(x,y,z)$, at time $\yti = \qty{0}{s}$, a football of \masse\ \qty{0.42}{kg} has instantaneous velocity $[0,0]\,\unit{m/s}$. The ball is hit at that time, and experiences a horizontal surface force (momentum influx) until time $\ytf = \qty{0.3}{s}$. The force changes with time as follows
\begin{equation*}
  \yF(t) =
  \begin{bmatrix}
  ...
  \end{bmatrix}\ .
\end{equation*}
During the same time interval, the ball experiences the vertical gravitational force (momentum supply).
\begin{enumerate}[exerc]
