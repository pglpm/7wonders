...
%% Last-Updated: 2026-03-09T19:28:00+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
For the potential energy of the cart we can use the constitutive relation $\ym\,g\,z$, since the cart is viewed as a point. We cannot use this constitutive relation for the ramp, because the ramp has a large vertical extension. However, the ramp is only moving horizontally, not vertically, so its gravitational potential energy must be constant; let's call it $\yE_{\text{p,r}}$.
...
\begin{equation*}
  \begin{aligned}
    ...
    + \ym_{\text{c}}\,g\,z_{\text{c}}(\ytf) + \yE_{\text{p,r}}
