...
%% Last-Updated: 2025-02-05T17:51:46+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anontrue
\newif\ifarxiv
...
\addsubsecref{sec:fluxes_scalar}
...
\addsubsecref{sec:fluxes_vector}
...
&\textcolor{red}{No \faIcon{thumbs-down}}
\\
\parbox[t]{0.25\linewidth}{\normalfont\raggedright Vector flux is expressed in components, and the coordinates are shown: we can reconstruct the vector if needed.}
&
&\parbox[t]{0.25\linewidth}{\normalfont\raggedright There should be just one vector indicating the flux. Unclear if the flux should have magnitude \qty{4}{N}.}
\\[5ex]
4.&5.&6.
\\
\textcolor{red}{No \faIcon{thumbs-down}}
