...
%% Last-Updated: 2026-03-02T21:23:18+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
%
\newcommand{\exercise}[2]{\section{#1}\label{#2}\marginpar{\vspace{-1.5\baselineskip}\hspace{-8em}\footnotesize Solution p.~\pageref{#2_sol}}}
...
Since we have one control volume, we only need one copy of the balance of momentum. The problem mentions two distinct time instants, therefore the integral expression of the balance law seems most convenient.
...
First let's see why an ordinary system of equations isn't enough; then we discuss the working solution.
