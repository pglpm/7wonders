...
%% Last-Updated: 2026-03-09T22:08:34+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
%
Two ice skaters are holding each other, completely still, at some time $\yti$. Then they push each other and at a later time $\ytf$ they're moving in opposite directions. Together they have burned \qty{76}{J} of internal energy in total.

Assume there's no friction or heat flux between ice and the skaters, air is negligible, and the gravitational potential energy of each skater is constant. The skater on the left has \masse\ \qty{70}{kg}, the one on the right \qty{60}{kg}. Each skater can be considered as a point, with zero vertical momentum.
...
If we consider the skaters as two separate control volumes, then we need to use one balance of momentum and one energy for each. Between the initial and final times there is obviously a flux and exchange of momentum, and possibly also of heat and of mechanical work, between the skaters. Therefore when we write the balances for each skater we need to explicitly take such fluxes of momentum and of energy into account. The text, however, does not give any information about these fluxes.

Therefore let's try first to solve the problem considering the skaters as a \emph{single control volume}, with one balance of momentum and one balance of energy. In this approach, the fluxes of momentum and energy between the skaters are \emph{internal} to the control volume, and therefore they don't appear in the balances of momentum and energy.

From the statement of the problem, the integral expression of the balances seems most convenient.

The constitutive relations are the usual ones, since we're dealing with matter, there are no matter fluxes through the volume boundaries, and there are no electromagnetic fields:
\begin{itemize}
...
\begin{equation*}
  ...
  \end{aligned}
\end{equation*}
This is just \emph{one example} of how we could write the physical laws and information about this physical system. When we write a set of equations like this, we decide how detailed or how summarizing we want to be. In the system above we could have been even more detailed, for instance adding the balance of $z$-momentum and additional information on the surface \amp\ volume forces in the $z$-direction. Or we could have combined several equations beforehand instead.
