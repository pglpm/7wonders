...
%% Last-Updated: 2025-02-10T12:01:58+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anontrue
\newif\ifarxiv
...
\item\label{item:team_B} Some other engineers show that if the constitutive law~\eqref{eq:const_block} is modified as follows:
  ...
  \end{equation}
  then together with the original conservation law~\eqref{eq:energy_block} it perfectly describes and predicts all experimental results.
\end{enumerate}
