...
%% Last-Updated: 2026-01-29T10:50:39+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\begin{itemize}
\item $\yRv(t) = \lambda_{\text{u}} \yNa(t)\,, \quad\yRu(t) = -\lambda_{\text{v}} \yNb(t)$\\ with different positive values for $\lambda_{\text{u}}$ and $\lambda_{\text{v}}$.

\item $\yRv(t) = \lambda \yNa(t)\, \yNb(t)\,, \quad\yRu(t) = -\lambda \yNa(t)\, \yNb(t)$\,.

\item $\yRv(t) = \lambda \sin[\yNa(t)\, \yNb(t)/\unit{mol^{2}}]\,, \quad\yRu(t) = -\lambda \sin[\yNa(t)\, \yNb(t)/\unit{mol^{2}}]$\,.
...
\begin{itemize}
\item $\yti = \qty{0}{s}$, $\yNa(\yti) = \qty{0}{mol}$, $\yNb(\yti) = \qty{0.04}{mol}$.
\item $\yJa = \yJb = \qty{0}{mol/s}$.
\item $\ytf = \qty{2e-7}{s}$, $\Dt = \qty{1e-10}{s}$.
\end{itemize}
