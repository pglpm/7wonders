...
%% Last-Updated: 2026-02-17T10:48:04+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
%
Three blocks of granite are arranged as shown in the margin figure. The blocks on the left and right touch the ground, and both sustain a third, central block, suspended from the ground. There are momentum fluxes (contact forces) at the four contact surfaces, depicted in the figure by \textcolor{blue}{blue arrows}; the forces on the central block are not displayed. The block on the left, denoted \enquote*{L}, has mass \qty{13000}{kg}; the one on the right, denoted \enquote*{R}, mass \qty{9000}{kg}; the central one, denoted \enquote*{C}, mass \qty{2000}{kg}. Air can be neglected.
