...
%% Last-Updated: 2026-03-17T10:49:37+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\marginpar{\vspace{3\baselineskip}\centering\footnotesize\includegraphics[width=\linewidth]{images/forces_block_1.jpg}%
%\\\flushleftright\color{mpcolor}%
}
%
An engineer has measured the surface forces applied on a block of a very light material at the points
\begin{equation*}
  \yra = [-0.2, 0, 0.1]\,\unit{m}
  \quad\text{and}\quad
  \yrb = [0.2, 0, -0.1]\,\unit{m} \ ,
\end{equation*}
