...
%% Last-Updated: 2026-03-20T10:40:49+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\begin{equation*}
    ...
    \begin{aligned}
      ...
      \tfrac12 \yIc \yo_{a}(\yti)^{2}
      +{}\\
      &\quad\yU_{b}(\yti) +
      \tfrac12\ym \bigl[v_{b,x}(\yti)^{2} + v_{b,z}(\yti)^{2}\bigr] +
