...
%% Last-Updated: 2026-03-09T18:42:59+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifanon
\anonfalse
\newif\ifarxiv
...
\marginpar{\vspace{0\baselineskip}\centering\footnotesize\includegraphics[width=1\linewidth]{images/ramp_cart_wheels.jpg}%
%\\\flushleftright\color{mpcolor}%
}
%
A ramp of mass \qty{20}{kg} and height \qty{1}{m}, equipped with small wheels, is at rest on the ground. At the top of the ramp there's a small cart of mass \qty{1}{kg}, also equipped with small wheels and also at rest. The cart is released, and at a later time $\ytf$ it is almost at the bottom of the ramp.

Assume that there are no heat fluxes. Air is negligible. The internal energies of ramp and cart are constant. The ramp is rigid. All wheels are small and their motion and dimensions can be neglected. Consider the cart as a small object identified simply by its position $\yr$. The wheels on the cart roll without sliding, therefore the velocity at their point of contact is zero with respect to the ground.
...
For the surfaces in contact with the air, no fluxes occur, because the text says that air is negligible. Fluxes can therefore only occur where the ramp's wheels touch the ground.

The momentum flux, or surface force, at the wheels surely has an upward $z$-component: the gravitational force pushes cart \amp\ ramp to the ground, so there must be a surface force from the ground to the cart that prevents the cart from sinking into the ground. The force from the ground might also have an $x$-component.

The energy flux, when matter is involved, comprises a heat flux $\yQ(t)$ and mechanical power $\yF(t)\cdot\yv(t)$. The text says that the heat flux is zero. For the mechanical power we must consider the force $\yF$ from ground to the ramp's wheels, and the velocity $\yv$ \emph{of the ramp's wheels at the point of contact}. The latter is always zero: $\yv = \zerov\,\unit{m/s}$. Therefore the mechanical power is also always zero: $\yF(t)\cdot\yv(t) = \qty{0}{J/s}$.
