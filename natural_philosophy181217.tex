...
%% Last-Updated: 2018-12-17T23:03:49+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{center}
  \textbf{Exchangeable models and related stuff}
\end{center}
...
\item Updating exchangeable models
\item Appearance of relative entropy
\item Kinds of prior parameter densities\\
  (Dirichlet priors, Jeffreys priors, entropic priors)
\item Sufficient statistics and parametric models\\
  (Ising models)
\item \enquote{Overtraining}
\item Partial exchangeability\\
  (neural networks)
\end{itemize}
