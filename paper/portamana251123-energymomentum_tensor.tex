...
%% Last-Updated: 2025-12-08T12:44:06+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{The energy-momentum tensor%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{The energy-momentum tensor}
...
%\else\settypeblocksize{*}{27.431}{1.618}% nearer to a 66-line newpx and preserves GR
\else\settypeblocksize{*}{26.1408pc}{1.618}% quadratic interpolation, 66-line newpx and preserves GR
\fi
...
\preauthor{\vspace{0pt}\begin{center}
\normalsize\sffamily%
\lineskip  0.5em}
...
\section{Peculiarities of energy and momentum}
\label{sec:intro}

The storage and transport of energy and of momentum are very important in our lives and in today's technologies. Our most precise non-quantum theory, general relativity, says that energy and momentum are aspects of one thing that is represented by a mathematical object called \enquote*{energy-momentum tensor} or \enquote*{energy-momentum-stress tensor} (with all sorts of permutations), or \enquote*{matter tensor}, or \enquote*{4-stress}, and other variations of these names. We shall call it \emph{energy-momentum tensor}.

This mathematical object is not only important in calculations and simulations involving cosmology or astrophysics. General relativity is part of everyday technologies like the Global Positioning System, the International Terrestrial Reference Frame, and the maintenance of 

Storage and transport of energy, as well as the motion of objects and the propagation of electromagnetic fields, are constantly on the limelight in today's technologies. Our most precise theory
...
%% coord-density useful because: 1. easier maths, 2. actual use (IGRS), 3. defined on null hypersurfaces.
%% virtual work
