...
%% Last-Updated: 2025-11-11T09:47:55+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
% british%
% ]{memoir}
\newcommand*{\firstdraft}{11 November 2025}
\newcommand*{\firstpublished}{\firstdraft}
\newcommand*{\updated}{\ifarxiv***\else\today\ [draft]\fi}
\newcommand*{\propertitle}{The Seven Wonders of the world\\{\large Subtitle}%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Seven Wonders}
...
\section{What's common to all physics branches?}
\label{sec:intro}
