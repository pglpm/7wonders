...
%% Last-Updated: 2025-11-23T09:16:27+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
That a \enquote{static} electromagnetic field configuration can store non-zero momentum is today no longer a matter of discussion, with plenty of experimental evidence and theoretical analyses.\autocites{pageetal1945}[Ch.~27]{feynmanetal1964_r2010}{romer1966,pughetal1967,furry1969,calkin1971,wallaceetal1980,casserberg1982,sharma1988,romer1995,narayan2021,grallaetal2022}[see also][]{poynting1905}[\sect~158]{page1928_r1958}{jonesetal1954,calkin1966,colemanetal1968,scanio1975,mcdonald1979_r2015,allenetal1990,majcenetal2000,mcdonald2003,mcdonald2006_r2019,harbola2010,griffiths2012,morrisetal2012,mcdonald2022b,mcdonald2022d} In the case of a \enquote{static} configuration the presence of non-zero momentum is still seen as counter-intuitive. In Griffiths's words:\autocites[\sect~1 p.~7]{griffiths2012}
\begin{quote}\footnotesize
  even purely \emph{static} fields can store momentum. How can a system at rest carry momentum?
\end{quote}

Singal \autocites{singal2016} appealed to the equivalence between total momentum and total energy flux, a consequence of the symmetry of the total energy-momentum tensor which is also connected to the balance of boost momentum\autocites{} and of angular momentum. Even in a \enquote{static} field configuration there can an energy flow; thus something -- energy -- is moving. This is an eminent explanation. But the energy flow itself may still be seen as counter-intuitive. Quoting Feynman, in his discussion of the space around a small charge and magnet: \autocites[\sect~27-5 p.~27-15]{feynmanetal1964_r2010}
\begin{quote}\footnotesize
  Also, $\bm{E}$ and $\bm{B}$ are quite static. But the Poynting vector says that there is a flow of energy, because there is an $\bm{E} \times \bm{B}$ that is not zero. If you look at the energy flow, you find that it just circulates around and around. There isn't any change in the energy anywhere--everything which flows into one volume flows out again. It is like incompressible water flowing around. So there is a circulation of energy in this so-called static condition. How absurd it gets!
\end{quote}

%
% check romer1995
%
%singal2016 explains by energy motion -- obvious from relativity because energy flux is proportional to momentum. Explanation here is different.

% franklinetal2024
% lorrainetal1993 on flux tubes
% wolfetal1996 on problems with electric field lines
% babsonetal2009 on momentum in \enquote{static} fields
% heaviside1892 on flux tubes
% thomson1904 on flux tubes
% thomson1891
% boyer2012
% hnizdo1997c on **stationary**
% hnizdo1997b hidden momentum
% johnsonetal1994
% hnizdo1992 torque
% vaidman1990 torque
% gurnettetal2005_r2017 flux tubes
% connerneyetal1993 flux tube Io
